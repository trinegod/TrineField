...
export const resumeTranslations: Record<Locale, ResumeCopy> = {
  ...
  ja: {
    pageTitle: "Steven Adkins - プロフェッショナル履歴書",
    kicker: "Steven Adkins / マスター履歴書",
    headline: "米国市場向けクリエイティブ＆プロダクトオペレーション / AI 支援プロダクト開発 / B2B パートナーシップ / カスタマー体験＆オペレーション / 国際ブランド戦略 / 英語＆スペイン語",
    back: "Trine に戻る",
    originalPdf: "英語の原本 PDF を開く",
    print: "印刷 / 日本語 PDF として保存",
    translationNote: "このページは Steven Adkins の英語版マスター履歴書を日本語で紹介したものです。正式な原本は英語版 PDF です。",
    summaryLabel: "職務要約",
    summary: "コンシューマーテクノロジー、SaaS、ライブコマース、デジタルヘルス、ナレッジ管理、品質保証、ワークフロー改善にわたり、15 年以上の経験を持つプロダクト、オペレーション、カスタマー体験、UX/UI、B2B パートナーシップのプロフェッショナル。現場のオペレーション知見と、AI 支援プロダクト開発、ユーザー中心の UX/UI 設計、B2B パートナーコミュニケーション、プロセス改善、米国市場・顧客への理解を組み合わせる。英語・スペイン語のバイリンガルで、デジタルプロダクトとクリエイティブ AI ワークフローの設計、構築、公開を実践している。",
    expertiseLabel: "コアスキル",
    expertise: ["プロダクトオペレーション", "UX/UI デザイン＆プロトタイピング", "AI 支援プロダクト開発", "カスタマー体験戦略", "B2B パートナーシップ＆コミュニケーション", "ワークフロー＆プロセス設計", "ナレッジ管理", "品質保証＆コーチング", "部門横断オペレーション", "米国市場戦略", "生成 AI＆プロンプト", "技術トラブルシューティング", "オペレーションレポート", "ブランド＆プロダクト教育"],
    experienceLabel: "職務経歴",
    experience: [
      {
        company: "Neura Health",
        title: "アクティベーションスペシャリスト / B2B パートナーシップ＆CX オペレーション",
        location: "アリゾナ州テンピ",
        dates: "2025 年 9 月 - 現在",
        bullets: [
          "電話、SMS、メールを通じた大量の患者アクティベーション業務を管理し、紹介・受付から保険給付確認、初回診療予約まで支援。",
          "医療システム、雇用主パートナー、脳震とう・脳損傷プログラム、傷害・法務紹介チャネルとの日常的な B2B 関係と組織間コミュニケーションを管理し、適格性、臨床ルーティング、免許要件、予約、引き継ぎを調整。",
          "オンボーディング、予約、保険、自費、スーパービル、その他の利用障壁について英語・スペイン語で支援。",
          "EHR、紹介プラットフォーム、トラッカー、共有ワークフローの記録を正確に保ち、引き継ぎ、フォロー責任、運用可視性を強化。",
          "紹介受付、予約、キャンセル、患者コミュニケーション、部門横断責任における反復的な摩擦を特定し、手作業を減らす改善を提案。",
        ],
      },
      {
        company: "Ro",
        title: "Tier 2 カスタマーサポートエージェント",
        location: "アリゾナ州メサ",
        dates: "2024 年 6 月 - 2025 年 9 月",
        bullets: [
          "Zendesk、電話、デジタルチャネルを通じ、アカウント、サブスクリプション、薬剤、請求、配送、プラットフォームに関する大量の Tier 2 ケースを担当。",
          "プロダクトとアプリの問題を調査し、反復する不具合、ユーザー摩擦、フィードバックを記録して技術・開発チームへエスカレーション。",
          "臨床・非臨床ルーティング、保険・給付の質問、確認業務、外部の事前承認支援を調整。",
          "顧客体験、ケア継続性、運用要件のバランスを取りながら、複雑な請求、サブスクリプション、履行ケースを解決。",
          "ユーザビリティ、請求、履行、サブスクリプション、ケア調整の反復課題を特定し、より強い業務とサービス提供を支援。",
        ],
      },
      {
        company: "Whatnot",
        ...
        dates: "2023 年 6 月 - 2024 年 7 月",
        bullets: [
          "買い手・売り手の複雑なマーケットプレイス問題と技術的異常を解決し、再現可能な不具合とユーザー影響を開発チームへ報告。",
          "AI プロンプトと生成 AI ツールを調査、文章作成、問題解決、業務効率化に活用し、顧客対応では独立した判断を維持。",
          "CSAT、解決品質、生産性、時間遵守、その他 KPI に関する QA レビュー、コーチング、パフォーマンス監視を実施し、スタッフを指導・研修。",
          "オペレーションレポートを分析し、外部 Tier 1 および Trust & Safety チームと連携して SOP 遵守、エスカレーション品質、プラットフォームポリシー、サービス性能を強化。",
        ],
      },
      {
        company: "Wix.com",
        title: "ナレッジベースライター / カスタマーサポートスペシャリスト",
        location: "フロリダ州マイアミビーチ",
        dates: "2018 年 1 月 - 2022 年 9 月",
        bullets: [
          "Wix の新製品・機能を調査し、顧客向けナレッジベースを執筆、公開、保守。パフォーマンスデータと製品変更に基づいて記事を更新または廃止。",
          "ウェブサイト、ドメイン、請求、決済、メール、SEO、デジタルコマースの高度な技術サポートを提供し、複雑な問題を解決または開発・品質保証へエスカレーション。",
          "エスカレーションを管理し、技術、請求、認証、アカウントの難しいケースでスタッフを支援。製品更新と運用変更をチームに共有。",
          "外部サポート運用の拡大を支援し、反復する製品・顧客摩擦を特定して文書、ワークフロー、顧客体験を改善。",
        ],
      },
    ],
    projectsLabel: "主なプロダクト＆AI プロジェクト",
    projects: [
      { title: "NODEINE - 創業者、プロダクトデザイナー＆フルスタック開発者", meta: "UX/UI デザイン、Next.js、TypeScript、Supabase、Vercel", description: "AI が生成したビジュアル世界とキャラクターのインタラクティブアーカイブを、情報設計、レスポンシブなコレクション閲覧、クリエイタープロフィール、作品ディスカッション、管理公開フローを含めて設計・開発。", links: [{ label: "公開ポートフォリオ", href: "https://fvck-art-gallery.vercel.app/" }, { label: "ソースコード", href: "https://github.com/trinegod/Fvck-Art-Gallery" }] },
      { title: "Patient Recovery OS - 独立系プロダクトプロトタイプ", meta: "AI 支援プロダクト＆UX/UI デザイン", description: "患者の進捗を整理し、実行可能な情報を提示し、複雑な業務を明確でユーザー中心の UX/UI に変換するケアオペレーションダッシュボードとガイド付きデモを設計。" },
      { title: "AI 映像ディレクション＆クリエイティブ制作 - Higgsfield / 独立プロジェクト", meta: "ナラティブ、ストーリーボード、シネマティックディレクション", description: "オリジナルイラストから Black Moon と Of The Streets を演出し、物語構造、ストーリーボード、ショット設計、キャラクター継続性、画像から動画へのプロンプト、台詞計画、縦型ソーシャルコンテンツを制作。" },
    ],
    additionalLabel: "その他の経験",
    additional: [
      { company: "Sony", title: "フォトグラファー / デジタルイメージングスペシャリスト", location: "フロリダ州マイアミ", dates: "2015 年 10 月 - 2017 年 12 月", description: "写真ワークショップと家電デモを担当。Best Buy チームを研修し、販売支援、店頭ブランド実行、競合情報の報告を行った。" },
      { company: "Tabas, Freedman, P.A.", title: "パラリーガル / オフィスアシスタント", location: "フロリダ州マイアミ", dates: "2012 年 2 月 - 2015 年 9 月", description: "Westlaw と TCMS を使った法務調査と文書業務を支援し、電子提出、申立書、修正スケジュール、資産評価、案件記録、期限の厳しい管理業務を担当。" },
      { company: "Best Buy", title: "Geek Squad", location: "フロリダ州マイアミ", dates: "2010 年 11 月 - 2012 年 2 月", description: "コンピューターハードウェアの診断・修理と、テクノロジーの提案販売、製品教育、サービス・保証提案、マーチャンダイジング支援を担当。" },
    ],
    technologyLabel: "テクノロジー＆ツール",
    technology: "UX/UI デザインとプロトタイピング、生成 AI、プロンプトエンジニアリング、Next.js、React、TypeScript、Tailwind CSS、Supabase、GitHub、Vercel、Zendesk、Slack、Google Workspace、CRM/EHR・紹介プラットフォーム、ナレッジベース、Westlaw、TCMS",
    educationLabel: "学歴、資格、言語",
    education: ["Florida International University - コンピューター・情報科学およびサポートサービス学士", "Google サイバーセキュリティ認定", "言語：英語（バイリンガル／ネイティブ）、スペイン語（バイリンガル／ネイティブ）、日本語（初級）"],
    sourceLabel: "出典：Steven Adkins マスター履歴書 / 2026 年 8 月更新",
  },
};
