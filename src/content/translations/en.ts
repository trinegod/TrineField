...
export const en: SiteCopy = {
  ...
  form: {
    ...
    failureText: "The private contact destination is not connected yet. Please use one of the direct contact links when available.",
  ...
  intro: {
    ...
    contactText: "Contact links are being finalized. Use the collaboration form on the main site to introduce a credible project or opportunity.",
